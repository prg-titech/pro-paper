...
\title{Compilation for Version Polymorphic\\Object-Oriented Programming Language}
...
\begin{abstract}
Programming with versions (PWV) introduced versions into the language semantics 
allowing version-safe multi-version programming. BatakJava, an object-oriented 
implementation of this concept, takes a nonrestrictive approach to PWV that allows 
...
compilation. However, the nature of multi-version programming inevitably would 
